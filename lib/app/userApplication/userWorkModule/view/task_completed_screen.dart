              ...
              children: [
                Consumer<UserProjectProvider>(
                  builder: (context, provider, child) {
                    ...
                    final taskInfo = provider.completeTaskApiResponse?.data;
                    if (taskInfo == null) return const Text("No task found");

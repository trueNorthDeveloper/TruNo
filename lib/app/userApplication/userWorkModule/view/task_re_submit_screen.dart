...
class _ResubmitScreenState extends State<ResubmitScreen> {
  ...
  Widget build(BuildContext context) {
    Provider.of<UserProjectProvider>(context, listen: false);
    return PopScope(
        canPop: !context.watch<UserProjectProvider>().isResubmitask,
              ...
              if (!didPop)
                {
                  ShowTaostMessage.toastMessage(
                    context,
                    "Please wait for the request to be finished.",
                  ),
                }
            },
        child: Scaffold(
                        ...
                        children: [
                          Consumer<UserProjectProvider>(
                            builder: (context, provider, child) {
                              ...
                              final completionDatee = DateTime.tryParse(taskInfo
                                  .task!.completionDate!
                                  .substring(0, 10));
                      ...
                      child: ElevatedButton.icon(
                          onPressed: () async {
                            ...
                            Map<String, dynamic> tojson = {
                              "message": submitMessageControllerr.text
                                  .toString()
                                  .trim(),
                            ...
                            await provider.toResubmitTask(tojson, files);

...
import 'package:truenorthflutterfrontend/app/userApplication/userHomePageModule/model/user_work_history_model.dart';
...
//al task with pagination
  Future<Result<ProjectTeamTask>> getAllProjectAndTeamTaskService(
      int currentPage, int size, int projectId, int teamId) async {
    try {
      //  String endPoint = "tnec-project/my-task-history?$currentPage&$size";
      String endPoint =
          "tnec-project/allTask/$projectId/$teamId?page=$currentPage&size=$size";
      ...
      if (response.statusCode == 200) {
        ...
        //  / print("data from server $data ");
          final taskResponse = ProjectTeamTask.fromJson(data);

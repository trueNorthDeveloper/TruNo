        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () async {
              ...
              print(leaveReasonController.text);

              if (leaveTypeController.text.isEmpty) {
                print("leave reason--------------");
                ShowTaostMessage.toastMessage(context, "select leave type");
                return;
              }
              if (dashboardProvider.toDateController.text.isEmpty) {
                print("leave reason--------------");
                ShowTaostMessage.toastMessage(context, "select date");
                return;
              }
              if (dashboardProvider.fromDateController.text.isEmpty) {
                print("leave reason--------------");
                ShowTaostMessage.toastMessage(context, "select date");
                return;
              }
              if (leaveReasonController.text.isEmpty) {
                print("leave reason--------------");
                ShowTaostMessage.toastMessage(context, "select leave reason");
                return;
              }

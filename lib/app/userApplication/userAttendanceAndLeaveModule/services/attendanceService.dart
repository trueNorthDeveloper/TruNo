...
import 'package:truenorthflutterfrontend/app/userApplication/userAttendanceAndLeaveModule/model/apply_leave.dart';
import 'package:truenorthflutterfrontend/app/userApplication/userAttendanceAndLeaveModule/model/can_apply_leave.dart';
import 'package:truenorthflutterfrontend/app/userApplication/userAttendanceAndLeaveModule/model/leave_history.dart';
import 'package:truenorthflutterfrontend/app/userApplication/userAttendanceAndLeaveModule/model/user_daily_attendance.dart';
import 'package:truenorthflutterfrontend/app/userApplication/userAttendanceAndLeaveModule/model/user_leave_logs.dart';
...
//THIS METHHOD FOR TEAM IF USER LOGIN ACCOUNT AS TEAM LEADER THIS METHOD WILL APPPEAR
  ...
  Future<Result> updateLeaveStausByTeamLeader(
      Map<String, dynamic> tojson) async {
    try {
      String endPoint = "attendance/updateApprovedStatus";
      final respones = await auth.patchRequest(endPoint, tojson);
      if (respones.statusCode == 200) {
        try {
          if (respones.body.isEmpty) {
            return Result.failure(ApiError.emptyResponse);
